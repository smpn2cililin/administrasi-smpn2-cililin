...
export const exportKonselingPDF = (konselingItem) => {
    try {
        ...
        const renderFooter = (pdfInstance, pageNumber) => {
            ...
            pdfInstance.text(`Dicetak: ${new Date().toLocaleDateString('id-ID')} | Sistem BK/BP SMPN 2 Cililin`, MARGIN_X, footerY);
        ...
        const renderHeader = () => {
            ...
            pdf.text('Bimbingan dan Konseling - SMPN 2 Cililin', PAGE_WIDTH / 2, yPosition, { align: 'center' });
