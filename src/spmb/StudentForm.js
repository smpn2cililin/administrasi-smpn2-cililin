...
<head>
<meta charset='utf-8'>
<title>Formulir Pendaftaran SMPN 2 Cililin</title>
<style>
  @page {
    size: A4;
    margin: 1.5cm;
...
<table class="signature-table">
  ...
  <tr>
    ...
    a.href = url;
    a.download = "Formulir_Pendaftaran_SMPN_2_Cililin_Cililin.doc";
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6 text-gray-800 flex items-center gap-3">
        ...
        Form Pendaftaran SMPN 2 Cililin
      </h2>
